...
class DemoWiringHostComponent {
  formValue: ExampleFormModel = { firstName: '', lastName: '', passwords: { password: '' } };
  formSuite = exampleFormValidationSuite;
...
class GroupWiringHostComponent {
  formValue: ExampleFormModel = { passwords: { password: '', confirmPassword: '' } };
  formSuite = exampleFormValidationSuite;
...
class WholeFormTypingHostComponent {
  formValue: ExampleFormModel = { firstName: '', passwords: { password: '' } };
  formSuite = exampleFormValidationSuite;
  errors: FormidableFormErrors = {};
}
...
describe('demo wiring: ngx-formidable + ngx-formidable/vest', () => {
  ...
  it('renders the Vest suite’s own messages on the field', fakeAsync(() => {
    ...
    // Straight out of `exampleFormValidationSuite`'s two `test('firstName', …)` rules.
