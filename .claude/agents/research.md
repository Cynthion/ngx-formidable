...
Read: the requirement; `@.documentation/*` (esp. application.md, architecture.md, \_backlog.md, implementation.md); code via Glob/Grep. WebSearch/WebFetch only for external unknowns.
