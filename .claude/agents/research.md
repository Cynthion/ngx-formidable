...
Read: the requirement; `@.documentation/*` (esp. architecture.md, conventions.md, implementation.md, ui_components.md); code via Glob/Grep. WebSearch/WebFetch only for external unknowns.
