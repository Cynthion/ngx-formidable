...
4. **Exercise it in the portal.** The portal's preview form is the showcase and the only visual test surface; a new field component is added to the field model so it renders and can be tried.
