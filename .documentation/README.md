...
Source of truth for outstanding work: `implementation.md`. How to write docs: `documentation.md`.

| File                | Purpose                                                             |
| :------------------ | :------------------------------------------------------------------ |
| `architecture.md`   | Workspace structure, library/demo roles, build & publish, key paths |
| `backlog.md`        | Raw intake buffer for new, untriaged ideas                          |
| `claude-code.md`    | The Claude Code setup for this repo                                 |
